...
//            rootVC.selectedViewController = navWordsVC
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.OALee.Pace" in the application's documents Application Support directory.
